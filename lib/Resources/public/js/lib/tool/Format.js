...
ag.u.sprintf = function(string)
{
    ...
    return this.vsprintf(string, args);
};
...
ag.u.numberFormat = function(val, decimals, trim)
{
    ...
    fractpart = this.numpad(Math.round(fractpart), decimals);
...
{
    var string = this.numberFormat(val, 2, false);
...
ag.u.duration = function(minutes)
{
    ...
    return this.sprintf(ag.intl.t("%sh %smin"), hours, minutes - hours * 60);
};
